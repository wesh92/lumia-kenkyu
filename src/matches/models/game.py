...
class UserGame(BaseModel):
    ...
    mmr_change: int = Field(..., alias='mmrGain')
    total_player_played_time: int = Field(..., alias='playTime')
    bots_added: int = Field(..., alias='botAdded')
    team_id: int = Field(..., alias='teamNumber') # Needed to group players in the same team later.
    pre_made: bool = Field(..., alias='preMade')
    ...
    main_weather: int = Field(..., alias='mainWeather')
    sub_weather: int = Field(..., alias='subWeather')
